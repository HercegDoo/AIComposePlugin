...
\t\t<li role="menuitem"><a class="edit responses active" onclick="return rcmail.command('switch-task', 'settings/plugin.basepredefinedinstructions')" role="button" href="#">Edit instructions</a></li>
\t</ul>
    </div>
  `
