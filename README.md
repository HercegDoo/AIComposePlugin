...
- **Full email translation:** In an opened message, choose a target language and click **Translate full email**. The complete text appears above the unchanged original, with progress for long messages and controls to hide or retry the translation.
